  ...
  return (
    <div>
      <div className="mx-auto h-full w-full flex items-center justify-center text-center relative">
        ...
        <div
          ref={heroRef}
          className="w-full max-w-screen-xl px-2.5 md:px-20 pb-28 pt-28 flex flex-col items-center justify-center text-center sm:pt-40"
        >
      ...
      <div className="mx-auto max-w-xl my-24">
        <FAQ />
      </div>
    </div>
  );
